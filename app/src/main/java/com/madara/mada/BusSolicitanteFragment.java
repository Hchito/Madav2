 ...
 * {@link BusSolicitanteFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link BusSolicitanteFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BusSolicitanteFragment extends Fragment {
    ...
    RecyclerView RecyclerSolicitante;
    DatabaseReference mDatabase;
    ProgressDialog progressDialog;

    private OnFragmentInteractionListener mListener;

    public BusSolicitanteFragment() {
     ...
     * @return A new instance of fragment BusSolicitanteFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static BusSolicitanteFragment newInstance(String param1, String param2) {
        BusSolicitanteFragment fragment = new BusSolicitanteFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_bus_solicitante, container, false);
        progressDialog = new ProgressDialog(getContext());
        mDatabase= FirebaseDatabase.getInstance().getReference();
        Buscar = view.findViewById(R.id.ETBuscar);
        RecyclerSolicitante = view.findViewById(R.id.Resultados_busqueda);
        RecyclerSolicitante.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        Buscar.setOnKeyListener(new View.OnKeyListener(){
                                    ...
                                    public boolean onKey(View v, int keyCode, KeyEvent event){
                                        if(event.getAction() == KeyEvent.ACTION_DOWN && !Buscar.getText().toString().isEmpty()){
                                            ...
                                            mDatabase.child("Proyect/db/Solicitante/").addListenerForSingleValueEvent(new ValueEventListener(){
                                                @Override
                                                public void onDataChange(@NonNull DataSnapshot dataSnapshot){
                                                    for(final DataSnapshot snapshot: dataSnapshot.getChildren()){
                                                        mDatabase.child("Solicitante/").child(snapshot.getKey()).addListenerForSingleValueEvent(new ValueEventListener() {
                                                            @Override
                                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot){
                                                    ...
                                                    adapterDatos.setOnClickListener(new View.OnClickListener(){
                                                        ...
                                                        public void onClick(View v){
                                                            Toast.makeText(getContext(),
                                                                    "UI: "
                                                                            + extend_uFindeds.get(RecyclerSolicitante.getChildAdapterPosition(v)).getId(),
                                                                    Toast.LENGTH_LONG).show();
                                                        }
                                                    });
                                                    RecyclerSolicitante.setAdapter(adapterDatos);
